      ...
      <div className='panel panel-default'>
        ...
        <div className='panel-body'>
          <Tabs
            ...
            id='selected-tab'
          >
            <Tab eventKey={1} title={<img src={images.crafting} alt={titles.crafting} />} />
            <Tab eventKey={2} title={<img src={images.furnace} alt={titles.furnace} />} />
            {minecraftVersion !== 'bedrock' ? [
              <Tab key={3} eventKey={3} title={<img src={images.blast} alt={titles.blast} />} />,
              <Tab key={4} eventKey={4} title={<img src={images.campfire} alt={titles.campfire} />} />,
              <Tab key={5} eventKey={5} title={<img src={images.smoking} alt={titles.smoking} />} />,
              <Tab key={6} eventKey={6} title={<img src={images.stonecutter} alt={titles.stonecutter} />} />
            ] : null}
          </Tabs>
