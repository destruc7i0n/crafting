...
export function CraftingArrow() {
  return (
    ...
    >
      {craftingArrowRuns.map(([x, y, width]) => (
...
const craftingArrowRuns = [
  ...
  [14, 13, 2],
  [14, 14, 1],
] as const satisfies readonly PixelRun[];

const furnaceFirePaths = [
  [
    "#8B8B8B",
    "M69 37h1v1H69zM69 38h1v1H69zM60 39h1v1H60zM60 40h1v1H60zM60 41h1v1H60zM65 41h1v1H65zM69 41h1v1H69zM60 42h1v1H60zM65 42h1v1H65zM60 43h1v1H60zM65 43h1v1H65zM70 43h1v1H70zM59 44h1v1H59zM65 44h1v1H65zM70 44h1v1H70zM64 45h2v1H64zM70 45h1v1H70zM60 46h1v1H60zM64 46h1v1H64zM70 46h1v1H70zM60 47h1v1H60zM69 47h1v1H69zM60 48h1v1H60zM65 48h1v1H65zM58 49h3v1H58zM63 49h3v1H63zM68 49h3v1H68z",
  ],
  [
    "#D84C45",
    "M58 36h1v1H58zM68 36h1v1H68zM59 37h1v1H59zM63 37h1v1H63zM67 37h1v1H67zM58 39h1v1H58zM64 39h1v1H64zM68 39h1v1H68zM63 41h1v1H63zM57 42h1v1H57zM69 42h1v1H69zM59 43h1v1H59zM62 43h1v1H62zM67 43h1v1H67zM64 44h1v1H64zM57 46h1v1H57zM69 46h1v1H69z",
  ],
  [
    "#FFB600",
    "M58 37h1v1H58zM68 37h1v1H68zM59 38h1v1H59zM63 38h1v1H63zM67 38h1v1H67zM58 40h1v1H58zM64 40h1v1H64zM68 40h1v1H68zM64 41h1v1H64zM59 42h1v1H59zM64 42h1v1H64zM67 42h1v1H67zM57 43h1v1H57zM69 43h1v1H69zM62 44h1v1H62zM59 45h1v1H59zM62 45h1v1H62zM67 45h1v1H67zM57 48h1v1H57zM59 48h1v1H59zM62 48h1v1H62zM67 48h1v1H67zM69 48h1v1H69z",
  ],
  [
    "#FFFF1F",
    "M59 39h1v1H59zM63 39h1v1H63zM67 39h1v1H67zM59 40h1v1H59zM67 40h1v1H67zM58 41h1v1H58zM68 41h1v1H68zM58 42h1v1H58zM63 42h1v1H63zM68 42h1v1H68zM64 43h1v1H64zM68 43h1v1H68zM57 44h1v1H57zM63 44h1v1H63zM69 44h1v1H69zM69 45h1v1H69zM59 46h1v1H59zM62 46h1v1H62zM67 46h1v1H67zM62 47h1v1H62zM64 47h1v1H64z",
  ],
  [
    "#FFFFFF",
    "M59 41h1v1H59zM67 41h1v1H67zM58 43h1v1H58zM63 43h1v1H63zM58 44h1v1H58zM68 44h1v1H68zM57 45h2v1H57zM63 45h1v1H63zM68 45h1v1H68zM58 46h1v1H58zM63 46h1v1H63zM68 46h1v1H68zM58 47h2v1H58zM63 47h1v1H63zM67 47h2v1H67zM58 48h1v1H58zM63 48h2v1H63zM68 48h1v1H68z",
  ],
] as const satisfies readonly PixelPath[];
...
export function StonecutterSelectionUi() {
  return (
    <svg
      ...
      shapeRendering="crispEdges"
    >
      <PixelPaths paths={stonecutterSelectionPaths} />
    </svg>
  );
}

const smithingHammerPaths = [
  [
    "#06070D",
    "M21 7h2v1H21zM21 8h2v1H21zM19 9h2v1H19zM23 9h2v1H23zM19 10h2v1H19zM23 10h2v1H23zM17 11h2v1H17zM25 11h2v1H25zM29 11h4v1H29zM17 12h2v1H17zM25 12h2v1H25zM29 12h4v1H29zM15 13h2v1H15zM27 13h2v1H27zM31 13h2v1H31zM15 14h2v1H15zM27 14h2v1H27zM31 14h2v1H31zM17 15h2v1H17zM29 15h2v1H29zM17 16h2v1H17zM29 16h2v1H29zM19 17h2v1H19zM31 17h2v1H31zM19 18h2v1H19zM31 18h2v1H31zM21 19h2v1H21zM33 19h2v1H33zM21 20h2v1H21zM33 20h2v1H33zM19 21h2v1H19zM23 21h2v1H23zM35 21h2v1H35zM19 22h2v1H19zM23 22h2v1H23zM35 22h2v1H35zM19 23h2v1H19zM23 23h2v1H23zM35 23h2v1H35zM17 24h2v1H17zM21 24h2v1H21zM25 24h2v1H25zM33 24h2v1H33zM17 25h2v1H17zM21 25h2v1H21zM25 25h2v1H25zM33 25h2v1H33zM15 26h2v1H15zM19 26h2v1H19zM27 26h2v1H27zM31 26h2v1H31zM15 27h2v1H15zM19 27h2v1H19zM27 27h2v1H27zM31 27h2v1H31zM13 28h2v1H13zM17 28h2v1H17zM29 28h2v1H29zM13 29h2v1H13zM17 29h2v1H17zM29 29h2v1H29zM11 30h2v1H11zM15 30h2v1H15zM11 31h2v1H11zM15 31h2v1H15zM9 32h2v1H9zM13 32h2v1H13zM9 33h2v1H9zM13 33h2v1H13zM7 34h2v1H7zM11 34h2v1H11zM7 35h2v1H7zM11 35h2v1H11zM7 36h4v1H7zM7 37h4v1H7z",
  ],
  [
    "#202129",
    "M19 13h2v1H19zM19 14h2v1H19zM19 15h4v1H19zM19 16h4v1H19zM21 17h4v1H21zM21 18h4v1H21zM23 19h4v1H23zM23 20h4v1H23zM25 21h4v1H25zM25 22h4v1H25zM25 23h4v1H25zM27 24h4v1H27zM27 25h4v1H27z",
  ],
  [
    "#2E2F38",
    "M21 9h2v1H21zM21 10h2v1H21zM19 11h6v1H19zM19 12h6v1H19zM21 13h6v1H21zM21 14h6v1H21zM23 15h2v1H23zM27 15h2v1H27zM23 16h2v1H23zM27 16h2v1H27zM25 17h2v1H25zM29 17h2v1H29zM25 18h2v1H25zM29 18h2v1H29zM27 19h2v1H27zM27 20h2v1H27zM29 21h2v1H29zM29 22h2v1H29zM29 23h2v1H29z",
  ],
  [
    "#3D3E48",
    "M25 15h2v1H25zM25 16h2v1H25zM31 19h2v1H31zM31 20h2v1H31zM33 21h2v1H33zM33 22h2v1H33zM33 23h2v1H33zM31 24h2v1H31zM31 25h2v1H31zM29 26h2v1H29zM29 27h2v1H29z",
  ],
  ["#3E2316", "M21 21h2v1H21zM21 22h2v1H21zM21 23h2v1H21z"],
  ["#4C2D1E", "M19 24h2v1H19zM19 25h2v1H19z"],
  ["#51525B", "M17 13h2v1H17zM17 14h2v1H17z"],
  ["#565868", "M27 17h2v1H27zM27 18h2v1H27zM31 21h2v1H31zM31 22h2v1H31zM31 23h2v1H31z"],
  ["#593828", "M17 26h2v1H17zM17 27h2v1H17zM11 32h2v1H11zM11 33h2v1H11zM9 34h2v1H9zM9 35h2v1H9z"],
  ["#6A4534", "M29 13h2v1H29zM29 14h2v1H29z"],
  ["#804C33", "M15 28h2v1H15zM15 29h2v1H15zM13 30h2v1H13zM13 31h2v1H13z"],
  ["#82ADB7", "M29 19h2v1H29zM29 20h2v1H29z"],
] as const satisfies readonly PixelPath[];
...
export function SmithingHammer() {
  return (
    <svg
      ...
      shapeRendering="crispEdges"
    >
      <PixelPaths paths={smithingHammerPaths} />
    </svg>
  );
}

function PixelPaths({ paths }: { paths: readonly PixelPath[] }) {
  return (
    <>
      {paths.map(([fill, d]) => (
