...
export function MinecraftVersionSelect({
  ...
  return (
    <Select
      ...
      className="border-primary/55 bg-primary/20 text-header-foreground hover:border-primary/70 hover:bg-primary/30 focus:ring-primary/50 dark:border-primary/40 dark:bg-primary/10 dark:hover:border-primary/55 dark:hover:bg-primary/15 dark:focus:ring-primary/35"
